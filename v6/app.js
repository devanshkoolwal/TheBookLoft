...
mongoose.connect("mongodb://localhost:27017/tbl_v6",{ useNewUrlParser: true,useUnifiedTopology: true });
    ...
    app.get("/book/:id" , function(req,res){
        Book.findById(req.params.id).populate("comments").exec(function(err, foundBook){
            if(err){
                ...
                // req.query({
                //     "product_url": "https://www.amazon.in/Fault-Our-Stars-Movie-Tie/dp/0141355077/ref=sr_1_2?crid=2B10UN8F46H3M&dchild=1&keywords=fault+in+our+stars&sprefix=fault+in+%2Caps%2C310&sr=8-2"
                // });
                ...
                // req.end(function (res) {
                    ...
                    //     "high_price":"26,380",
                    //     "id":"B07B428M7F",
                    //     "image":"https://images-na.ssl-images-amazon.com/images/I/61wP16xC7tL._AC_UL160_SR160,160_.jpg",
                    //     "low_price":"17,711",
                    //     "productUrl":"https://www.amazon.in/gp/product/B07B428M7F/",
                    //     "shortUrl":"w_q1",
                    //     "status":true,
                    //     "store":"Amazon",
                    //     "title":"AMD Ryzen 7 2700X Desktop Processor 8 Cores up to 4.3GHz 20MB Cache AM4 Socket (YD270XBGAFBOX)"
                    //     }
                ...
                const product=fetchPrice();
                console.log(product.name)
                console.log(product.price)
                console.log(product.isAvailable)
                console.log(product.productCode)

                const uri = 'https://www.amazon.in/dp/9389717345';
...
async function fetchPrice(){
    const product=await pricefinder("https://www.amazon.in/dp/B073D36KNM", "amazon");
    // console.log(product.name)
